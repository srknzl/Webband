...
const LADIES = [
    ...
    { id:'nelda',   name:'Leydi Avrilia',   faction:'swadia',  guardianId:'reylan',   homeLocId:'castle_s2', trait:'pious',     lore:'Şafak duasını hiç kaçırmaz. Ganimet sandığına elini bile sürmediği söylenir.' },
...
const Nobles = {
    ...
    talk(id) {
        ...
        // Renown gates (#69): a companion speaks for you at 500, the king's banner is asked for at 800
        if(Game.envoyCompanions().length || state.envoy)
